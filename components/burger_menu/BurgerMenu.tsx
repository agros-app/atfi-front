  ...
  return (
    <div className={styles.hamburgerMenu}>
      ...
      <ul className={styles.menuBox}>
        ...
        <li>
          <Link className={styles.menuItem} href="/projects">
            Proyectos
          </Link>
        </li>
        <li>
          <Link className={styles.menuItem} href="/portfolio">
            Portfolio
          </Link>
        </li>
        {user && (
        ...
        <li>
          <Link className={styles.menuItem} href="/perfil">
            Perfil
          </Link>
        </li>
        {user ? (
          <>
            <li>
              <Link className={styles.menuItem} href="/" onClick={logOut}>
                Cerrar sesión
              </Link>
            </li>
          </>
