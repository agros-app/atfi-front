...
export default function Tab() {
    ...
    const content: Record<Tabs, JSX.Element> = {
        'resumen':(<div className={styles.body}>
            ...
            <p>Vulputate mi sit amet mauris commodo quis imperdiet. Elementum nibh tellus molestie nunc non blandit
                massa enim nec. Ut etiam sit amet nisl purus in. Nunc id cursus metus aliquam eleifend. Praesent
                elementum facilisis leo vel fringilla est ullamcorper eget nulla. Nisl</p>
        ...
        "cronograma": <div className={styles.body}>
