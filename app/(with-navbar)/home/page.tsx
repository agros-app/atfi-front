...
const news = [
  {
    ...
    description:
      'Un informe de la Bolsa de Comercio señala menor volumen negociado debido a la seca.',
    onButtonClick: () =>
      (window.location.href =
        'https://www.clarin.com/rural/agricultura/mercado-granos-2023-crecio-canje_0_w33D993XUn.html?srsltid=AfmBOopkS70f7PlJ0EPP9_rSoKOuz0nf65JZlMquOlml_EMAC0h_Gl_X')
  },
  {
    imageSrc: image,
    newspaper: 'La Nación',
    ...
    description:
      'La suba de los precios internacionales de los insumos preocupa a los productores.',
    onButtonClick: () =>
      (window.location.href =
        'https://www.lanacion.com.ar/economia/campo/alerta-se-descontrolo-una-variable-que-mira-el-campo-y-el-negocio-esta-en-zona-de-riesgo-nid21032024/')
  },
  {
    imageSrc: image,
    newspaper: 'Infobae',
    ...
    description:
      'La falta de lluvias en el norte del país afecta la producción de granos.',
    onButtonClick: () =>
      (window.location.href =
        'https://www.lanacion.com.ar/economia/campo/alerta-se-descontrolo-una-variable-que-mira-el-campo-y-el-negocio-esta-en-zona-de-riesgo-nid21032024/')
  },
