...
const ContactForm = () => {
    return (
        <div className={styles.contactFormContainer}>
            <h2 className={styles.heading}>Comenza la transformacion digital de tu campaña agriculo</h2>
            <div className={styles.content}>
                ...
                <form className={styles.form}>
                    ...
                    <TextField rows={4} type={"textarea"} placeholder="Mensaje" name="message" />
                </form>
            </div>
        </div>
    );
