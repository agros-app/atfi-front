        ...
        <div className={styles.container}>
            ...
            <div className={styles.division}>
                <div className={styles.firstRow}>
                    ...
                    <img src={"/wallets/binance_black.png"} alt="Binance" className={styles.binanceIcon}/>
                </div>
                <div className={styles.secondRow}>
                    <img src={"/wallets/MetaMask.png"} alt="Metamask" className={styles.metamaskIcon}/>
                    <img src={"/wallets/okx-1.svg"} alt="OKX" className={styles.okxIcon} />
                </div>
            </div>
